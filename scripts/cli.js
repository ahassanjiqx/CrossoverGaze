...
const contractABI = require("../artifacts/contracts/Crossovergaze.sol/Crossovergaze.json").abi;

program
    .name("crossovergaze-cli")
    .description("CLI tool for Crossovergaze smart contract")
    .version("1.0.0");
